import { DocumentSnapshot } from "./apiFire.js";
import {
  catchas, inicio, intersección, preparaParaBúsqueda, error, valida
} from "../js/lib/util.js";
import { collection, toOp } from "./utilFire.js";
import { Auth } from "./apiAuth.js";
...
/**
 * @param {import("./apiAuth.js").UsuarioAuth} usuarioAuth 
