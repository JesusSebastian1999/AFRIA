...
export class Firestore {
    /** Devuelve unainstancia de <code>CollectionReference</code> que apunta a
     * una colección localizada en la ruta especificada.
     * @param {string} _ruta ruta a la collection separada por diagonales.
     * @returns {CollectionReference} */
    collection(_ruta) { throw new Error("interface"); }
    /**
     * @template T
     * @param {(tx:Transaction) => Promise<T>} _fun función que ejecuta la
     * transacción.
     * @returns Promise<T> El resultado de la transacción.*/
    runTransaction(_fun) { throw new Error("interface"); }
  }
